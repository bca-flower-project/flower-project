    ...
    <Container fluid className="loginWrapper">
      <Row className="justify-content-center">
        <div className="col-sm-4">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to oK L3C, 2722 Mt. Rd. Bristol, VT
                05443.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: Vermont, United States
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to flowers.community, accessible
                from{" "}
                <a
                  href="flowers.community"
          ...
          <ul>
            <li>
              <p>By email: connect@oK.community</p>
            </li>
            <li>
              <p>
                ...
                <a
                  ...
                  target="_blank"
                >
                  https://www.ok.community/connect
                </a>
              </p>
            </li>
          </ul>
