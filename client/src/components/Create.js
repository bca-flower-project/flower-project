...
export default function Create() {
    ...
    return (
        <div>
            ...
            <div class="teardrop" id="peaks">Peaks</div>
            <div class="teardrop" id="challenges">Challenges</div>
            <div class="teardrop" id="people">People</div>
            <div class="teardrop" id="principles">Principles</div>
            <div class="teardrop" id="power">Power</div>
            <div class="teardrop" id="aspirations">Aspirations</div>
        </div>
    )
}
