  ...
  return (
    ...
    <div id="navbar">
      {/* <Link to="/">Home</Link> */}
       ...
       <Link to={"/PastFlowers"}><img src={spiral} alt="spiral" id="navspiral"/></Link>
      <Link to={"/Create"}><img src={blackflower} alt="flower"id="navflower"/></Link>
      <Link to={"/Global"}><img src={blackglobe} alt="globe" id="navglobe"/></Link>
